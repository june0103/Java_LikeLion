...
// Package : Java에서 java파일과 class파일들을 폴더 단위로 관리하기 위한 목적
// Package에 포함되지 않은 파일들은 default package에 포함
// Package에 포함되어 있는 파일들은 상단 다음과 같이 작성
// package 패키지명

// 같은 패키지에 있는 클래스들은 자유롭게 사용이 가능
// 다른 패키지에 있는 클래스들은 import를 사용하여 클래스가 어떤 패키지에 있는지 알려줘야한다.
import com.test.pkg1.TestClass10;
import com.test.pkg1.TestClass11;

// * 을 이용하면 지정된 패키지의 모든 클래스를 import 할 수 있다.
import com.test.pkg2.*;

// 위에서 TestClass10은 com.test.pkg1에있다고 명시하였기 때문에
// 패키지가 다르더라도 같은 이름의 클래스를 import할 수 없다.
// import com.test.pkg3.TestClass10;

// pkg2와 pkg3에 각각 TestClass20 이 있기 때문에 TestClass20을 사용하는 곳에서 오류발생
...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		// import 된 다른 패키지의 클래스와 동일한 이름의 클래스를 사용 할 때는
		// 앞에 패키지명을 반드시 붙혀줘야 한다.
