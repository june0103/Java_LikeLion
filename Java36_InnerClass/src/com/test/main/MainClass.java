...
// 지역 중첩 클래스
// 메서드 내부에 클래슬르 작성하여 사용하는 클래스
// 메서드의 수행이 끝나면 클래스가 메모리에서 사라지기 때문에 메서드 외부에서 클래스를 사용할 수 없다
// 장점 : 메서드에서 사용하는 클래스를 작성할 때 다른 곳에 작성하지 않고 바로 작성해 사용 할 수있다
// 단점 : 메서드 내부에서만 사용이 가능하다
class OuterClass3 {

	// 지역 중첩클래스 타입의 멤버변수 선언 불가능
//	InnerClass3 in30;
