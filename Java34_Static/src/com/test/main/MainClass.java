...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		// 객체 생성없이 멤버변수 사용
		// static이 아닌 멤버 들은 객체를 생성해야지만 사용할 수 있기 때문에 static 처럼 클래스 이름으로 접근하는 것은 불가능 하다.
		System.out.printf("TestClass1.memberA : %d\n", TestClass1.memberA);
		TestClass1.method1();

		// 객체를 생성
		TestClass1 t1 = new TestClass1();
		// 객체 참조 변수를 통해 객체의 멤버에 접근
...
class TestClass1 {
	...
	public void method1() {
		...
		// 객체를 생성해야지만 사용할 수 있는 메서드로 모든 static 요소에 접근가능
	...
	public static void method2() {
		...
		// static 메서드는 객체를 생성하지 않아도 호출이 가능하기 때문에 객체의 멤버에는 접근 불가능
		System.out.printf("memberA : %d\n", memberA);
		System.out.printf("memberB : %d\n", memberB);
		method1();
