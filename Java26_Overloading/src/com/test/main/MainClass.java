...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		// Overloading
		// 메소드가 생성자를 작성할 때 매개변수의 형태를 다르게하여 같은 이름으로 여러개를 만들 수 있도록 제공되는 개념
...
//		this.memberB = 200;
	...
	// 메서드도 이름을 동일하게하고 매개변수의 형태를 다르게하여 메서드를 여러개 만들수 있다.
	...
	// 매개 변수를 작성할 때 ... 를 붙혀주면 전달 되는 값들을 배열로 만들어 사용할 수 있다.
